    ...
    class Wt_Smart_Coupon_Public {
        ...
        */
        ...
        public static function get_user_coupons($user = '', $offset = 0, $limit = 30, $args = array())
        {
            ...
            {
                //expiry date check
                $sql .= " AND (expiry = '' OR FROM_UNIXTIME(UNIX_TIMESTAMP(expiry)) >= CURRENT_DATE())";
            ...
            }else /* 'expired_coupons' */
            {
                ...
                $sql .= " AND (
                    (expiry != '' AND FROM_UNIXTIME(UNIX_TIMESTAMP(expiry)) < CURRENT_DATE()) OR 
            ...
            $post_ids = $wpdb->get_results($final_sql);
